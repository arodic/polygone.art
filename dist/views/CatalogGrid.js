...
let CatalogGrid = class CatalogGrid extends ReactiveElement {
    static get Style() {
        return /* css */ `
      :host {
        display: block;
      ...
      :host > .height-padding {
        display: block;
        width: 1px;
        height: var(--catalogGridHeight);
        position: absolute;
      }
      :host > .top-padding {
        display: block;
        height: var(--catalogGridTop);
      }

      :host > poly-thumbnail {
        width: calc(var(--catalogGridCellSize) - 0px);
        height: calc(var(--catalogGridCellSize) - 0px);
        cursor: pointer;
      }
    ...
    mutated() {
        ...
        this.style.setProperty('--catalogGridCellSize', `${itemSize}px`);
        this.style.setProperty('--catalogGridHeight', `${height}px`);
        this.style.setProperty('--catalogGridTop', `${top}px`);
        this.render([
...
__decorate([
    Property('')
], CatalogGrid.prototype, "size", void 0);
__decorate([
    Property('')
], CatalogGrid.prototype, "type", void 0);
__decorate([
    Property('')
], CatalogGrid.prototype, "filter", void 0);
__decorate([
    Property('')
], CatalogGrid.prototype, "assetsSrc", void 0);
__decorate([
    Property('')
], CatalogGrid.prototype, "thumbsSrc", void 0);
__decorate([
    Property({ type: Object, init: null })
], CatalogGrid.prototype, "assets", void 0);
__decorate([
    Property({ type: Array, init: null })
], CatalogGrid.prototype, "items", void 0);
__decorate([
    Property({ type: Object, init: null })
], CatalogGrid.prototype, "thumbnails", void 0);
CatalogGrid = __decorate([
    Register
], CatalogGrid);
export { CatalogGrid };
export const catalogGrid = function (props) {
    return CatalogGrid.vConstructor(props);
};
