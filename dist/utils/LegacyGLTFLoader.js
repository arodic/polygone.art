            ...
            return new Promise(function (resolve) {
                ...
                textureLoader.load(resolveURL(sourceUri, options.path), function (_texture) {
                    ...
                    if (texture.name !== undefined)
                        ...
                        _texture.name = String(texture.source);
                    ...
                    console.warn('[LegacyGLTFLoader] Failed to load texture:', resolveURL(sourceUri, options.path));
                    resolve(null);
                });
            });
        });
            ...
            return _each(json.materials, function (material) {
                ...
                if (khr_material) {
                    ...
                    keys.forEach(function (v) {
                        if (khr_material.values[v] !== undefined)
                ...
                if (materialType !== DeferredShaderMaterial && pendingUniforms) {
                    _material.uniforms = pendingUniforms;
                    _material.userData.tiltGltfUniforms = pendingUniforms;
                }
                return _material;
            });
        });
                ...
                for (var channelId in animation.channels) {
                    ...
                    if (sampler) {
                        ...
                        if (node) {
                            ...
                            tracks.push(new TypedKeyframeTrack(targetName + '.' + PATH_PROPERTIES[target.path], Array.prototype.slice.call(inputAccessor.array), Array.prototype.slice.call(outputAccessor.array), interpolation));
                        }
                    }
                }
            ...
            return _each(json.scenes, function (scene) {
                ...
                _scene.traverse(function (child) {
                    ...
                    if (meshChild.material && meshChild.material.isRawShaderMaterial) {
                        ...
                        meshChild.onBeforeRender = function (_renderer, scene, camera) {
