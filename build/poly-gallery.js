...
let PolyGallery = class PolyGallery extends IoElement {
    static get Style() {
        return /* css */ `
    :host {
      display: block;
    ...
    applyFilter() {
        ...
        const indexOf = (item, filter) => {
            if (item instanceof Array)
                return item.findIndex(item => filter.toLowerCase() === item.toLowerCase());
    ...
    changed() {
        ...
        const filteredList = this.items.slice(this.currentBase * this.columnCount, this.currentBase * this.columnCount + listSize);
...
__decorate([
    Property(256)
], PolyGallery.prototype, "computedSize", void 0);
__decorate([
    Property(0)
], PolyGallery.prototype, "currentBase", void 0);
__decorate([
...
export { PolyGallery };
//# sourceMappingURL=poly-gallery.js.map