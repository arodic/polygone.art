...
vec3 computeLighting(vec3 normal) {
  // Facing is already handled inside PerturbNormal (tangent-space bump).
  // Do not flip again here — that was leftover from the old height-map path and
  // double-darkens backfaces vs OilPaint / Paper / ThickPaint.
