 ...
 */
function lightDirectionFromTBEuler(rotDeg: Vector3, flipY: boolean): Vector3 {
  const euler = new Euler(
    MathUtils.degToRad(rotDeg.x),
...
export class TiltEnvironmentLoader {
   ...
   */
  async load(sketchRoot: Object3D, userData: Record<string, unknown>): Promise<{
